...
class RayCasting:
    ...
    def ray_cast(self):
        ...
        ray_angle = self.game.player.angle - HALF_FOV + EPS
        for ray in range(NUM_RAYS):
            sin_a = math.sin(ray_angle)
            cos_a = math.cos(ray_angle)

            # horizontals
            y_hor, dy = (y_map + 1, 1) if sin_a > 0 else (y_map - EPS, -1)
            ...
            # verticals
            x_vert, dx = (x_map + 1, 1) if cos_a > 0 else (x_map - EPS, -1)
            ...
            #              (ox * 100 + depth * cos_a * 100, oy * 100 + depth * sin_a * 100), 2)
